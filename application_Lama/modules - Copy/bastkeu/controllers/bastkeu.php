...
class Bastkeu extends Admin_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('bastkeu_model', 'data_model');
		$this->load->model('auth/login_model', 'auth');
	}

	public function index()
	{
		$data['breadcrumbs'] = 'Daftar BAST Bantuan Keuangan';
		$data['title'] = PRODUCT_NAME.' - '.$data['breadcrumbs'];
		$data['link_daftar'] = '/get_daftar';
		$data['modul'] = 'bastkeu';
		$data['main_content'] = 'bastkeu_view';
	...
	{
		$data['title'] = PRODUCT_NAME.' - '.'BAST - Bantuan Keuangan';
		$data['modul'] = 'bastkeu';
		...
		$data['main_content']='bastkeu_form';
		$this->load->view('layout/template',$data);
	}
