...
<form id="frm" method="post" action="<?php echo base_url(); ?>bastkeu/<?php echo $link_proses;?>" enctype="multipart/form-data">
	<fieldset>
	...
	<fieldset>
		<legend>Data Penerima Bantuan Keuangan</legend>
		<div class="controls-row">
...
$(document).ready(function() {
	...
	var ModelBAST = function (){
		...
		self.title = ko.computed(function(){
		  return (self.mode() === 'edit' ? 'Edit ' : 'Entri ') + self.modul + ' - Bantuan Keuangan';
		});
	...
	App.pilih_uraian = function(){
		...
		var option = {multi:0, lvl:0, tree:2, id_skpd:App.id_skpd(), mode:'BANKEU'};
