...
function param(i,j)
{
	...
	var data = {'id_bidang':id_bidang, 'id_skpd':id_skpd, 'jenis_bantuan':jenis_bantuan,'kategori':kategori,'id_kegiatan':id_kegiatan, 
			'tgl_awal':tgl_awal, 'tgl_akhir':tgl_akhir, 'i':i, 'j':j};
...
function pilih_filter()
{
	$('#pilih').click(function() {
      ...
      keperluan = $('#Keperluan').val(),
		...
		var param = {'tgl_lapor':tgl_lapor, 'tgl_awal':tgl_awal, 'tgl_akhir':tgl_akhir, 
      'no_hlmn':no_hlmn, 'realisasi':realisasi, 'bulan':bulan, 'header':header,
      'semester':semester, 'tipe':tipe, 'jenis_sp2d':jenis_sp2d, 'id_sd':id_sd, 
      'histori':histori, 'id_bidang':id_bidang, 'id_skpd':id_skpd,'jenis_bantuan':jenis_bantuan,'kategori':kategori, 'kode_rek':kode_rek,
      'id_pa':id_pa, 'id_ppk':id_ppk, 'id_bp':id_bp, 'id_kegiatan':id_kegiatan,
      'id_rekening':id_rekening, 'keperluan':keperluan, 'file':file, 'format':format};
