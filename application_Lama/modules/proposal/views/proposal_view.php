...
$(document).ready(function() {
  ...
  $("#grid").jqGrid({
    ...
    datatype:'json',
    mtype:'POST',
    colNames:['Nomor Proposal', 'Nama Pemohon', 'Alamat Pemohon', 'Tanggal Masuk', 'Program', 'Kegiatan', 'Rekening', 'Nominal Pengajuan', 'Nominal Persetujuan', 'Status'],
    colModel:[
        {name:'no', width:100},
        {name:'nama_pmh', width:150},
        {name:'alamat_pmh', width:200},
        {name:'tgl', width:100, formatter:'date', align:'center'},
        {name:'program', width:150},
        {name:'kegiatan', width:150},
        {name:'rekening', width:150},
        {name:'nom_aju', width:120, formatter:'currency', align:'right'},
        {name:'nom_setuju', width:120, formatter:'currency', align:'right'},
  ...
  {
    var SumNomSetuju = $("#grid").jqGrid('getCol', 'nom_setuju', false, 'sum');
    $("#grid").jqGrid('footerData','set',{akhir:'',nom_setuju:SumNomSetuju});
