  ...
  var modul = 'fungsi';
	jQuery(document).ready(function() {
		...
		jQuery("#grid").jqGrid({
			...
			colModel:[
				{name:'kode',index:'kode_fungsi',width:150,editable:true,edittype:'text',editoptions:{size:20},editrules:{required:true, integer:true}},
				{name:'nama', index:'nama_fungsi',width:300,editable:true,edittype:'text',editoptions:{size:50},editrules:{required:true, integer:false}}
			],
			rowNum:10,
			rowList:[10,20,30],
			rownumbers:true,
