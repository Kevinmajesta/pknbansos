<?php
class Bastkeu_model extends CI_Model {
	...
	function get_rincian($id_skpd,$id_rekening,$id_rincian_anggaran)
	{
		$result = $this->db->query("
			...
			join form_anggaran fa on fa.id_form_anggaran = ra.id_form_anggaran
			join tahun_anggaran ta on ta.tahun = fa.tahun and ta.status_kini=fa.status
			left join bast ba on ba.id_rincian_anggaran=ra.id_rincian_anggaran and ba.jenis='BANKEU'
