...
<form id="frm" method="post" action="<?php echo base_url(); ?>bastnon/<?php echo $link_proses;?>" enctype="multipart/form-data">
	<fieldset>
	...
	<fieldset>
		<legend>Data Penerima Bantuan Non Proposal</legend>
		<div class="controls-row">
...
$(document).ready(function() {
	...
	function sisa_rekening(){
		...
		console.log(App.sisa_sp2d(),'App.sisa_sp2d sisa_rekening');
		console.log(App.nom(),'App.nom sisa_rekening');
		console.log(App.sisa_sp2d_asli(),'App.sisa_sp2d_asli sisa_rekening');
	...
	var ModelBAST = function (){
		...
		self.pekerjaan = ko.observable(<?php echo isset($data['PEKERJAAN']) ? json_encode($data['PEKERJAAN']) : "''" ?>)
		  .extend({
			required: {params: true, message: 'Instansi/Organisasi belum diiisi'},
		...
		self.title = ko.computed(function(){
		  return (self.mode() === 'edit' ? 'Edit ' : 'Entri ') + self.modul + ' - Bantuan Non Proposal';
		});
	...
	App.pilih_uraian = function(){
		...
		var option = {multi:0, lvl:0, tree:2, id_skpd:App.id_skpd(), mode:'BANSOSNON'};
