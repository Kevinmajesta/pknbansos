...
jQuery(document).ready(function() {
	...
	jQuery("#gridSKPD").jqGrid({
		url:'<?php echo base_url()?>skpd/get_skpd_dpa1',
		datatype: "json",
        mtype:'POST',
		...
		ondblClickRow:function(){
			...
			//cari pejabat skpd
			var id_skpd = jQuery('#ID_SKPD').val();
			jQuery.getJSON('<?php echo base_url();?>dpa_skpd1/get_pejabat/'+id_skpd, function(json) {
			...
			//cari pejabat daerah
			jQuery.getJSON('<?php echo base_url();?>dpa_skpd1/get_pejabat_daerah/', function(json) {
			...
			jQuery('#tableRincianAnggaran').jqGrid('setGridParam', {url:'<?php echo base_url();?>dpa_skpd1/get_daftar_rincian/'+form_anggaran})
			...
			jQuery('#tableAnggaranKas').jqGrid('setGridParam', {url:'<?php echo base_url();?>dpa_skpd1/get_anggaran_kas/'+form_anggaran})
